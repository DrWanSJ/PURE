...
%   protocol: docs/audit/manual_fig4_audit_protocol.md with the template
%   data/manual_audit/fig4_human_digitization_template.csv (simulator
%   output hidden during reading). Status is also written to
%   data/processed/literature/R01/fig4/fig4_digitized_validation_status.json.
%
%   DIGITIZE_FIG4()
%
...
%
%   Outputs:
%     data/processed/literature/R01/fig4/fig4_digitized_all_clusters.csv   every cluster
%     data/processed/literature/R01/fig4/fig4_digitized.csv                calculated-curve pick
%         provenance: digitized_from_Mavelli_2015_Fig4
%     results/baselines/b1_mavelli2015/fig4_digitized_comparison.csv
%         digitized calculated curve vs new_simulation at the sample times
%
%   Limitations (registered in docs/project/benchmark_registry.md, L1):
...
d    = fileparts(mfilename('fullpath'));   % .../matlab/tools/digitization
root = fileparts(fileparts(fileparts(d)));
png  = fullfile(root, 'data', 'raw', 'literature', 'R01', ...
    'mavelli2015_fig4_page14_300dpi.png');
proc = fullfile(root, 'data', 'processed', 'literature', 'R01', 'fig4');
resd = fullfile(root, 'results', 'baselines', 'b1_mavelli2015');
...
status.independent_validation_protocol = 'docs/audit/manual_fig4_audit_protocol.md';
