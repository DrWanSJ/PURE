...
xlabel(tl, {'time (h)', ...
    'new_simulation only - experimental dotted curves (Stoegbauer 2012) not overlaid; raster digitization of the calculated curves: data/processed/fig4_digitized.csv'}, ...
    'FontSize', 9.5);
xlim([0 4]);
...
summary.fig4_note = ['Calculated curves reproduced from the literal model translation. ' ...
    ...
    'The paper''s CALCULATED curves were digitized from the raster figure by matlab/simulate/digitize_fig4.m ' ...
    '(provenance: digitized_from_Mavelli_2015_Fig4) -> data/processed/fig4_digitized.csv; ' ...
    'quantitative comparison: results/literature_reference/fig4_digitized_comparison.csv ' ...
