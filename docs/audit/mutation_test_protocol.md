...
Mutation: in `matlab/src/simulate/simulate_pure_literature_reference.m`, change
...
why the blind human Fig. 4 audit (`docs/audit/manual_fig4_audit_protocol.md`)
...
Mutation: in `matlab/src/simulate/simulate_pure_literature_reference.m`
