...
| --- | --- | --- | --- | :---: |
| High | Complete `docs/audit/human_b1_audit.md` line by line | Repository tests and AI-assisted/source audits do not replace an independent scientific reading | automated/equation-level checks pass; checklist not completed | no |
...
- Do **not** redo nonnegativity or conservation merely because the user has not personally inspected them yet. Machine QC already reports them as passed. The human task is to understand/audit the definitions and evidence chain.
